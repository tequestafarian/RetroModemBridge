...
## v3 Beta 3 feature pass

See `RELEASE-NOTES-v3.0-beta.3.md` for the Test All Favorites, profiles, support bundle, filters, and local BBS service additions.


## v3 Beta 3 Major Release

RetroModem Bridge v3 Beta 3 is the biggest update so far. It adds a local BBS-style menu for the retro computer, searchable/paged BBS directory, retro-side Import Guide browser, Monthly/Daily guide updates, Session Mirror, favorites, dial history, connection testing, support bundle export, profiles, and a new app icon.

See `RELEASE-NOTES-v3.0-beta.3.md` for the full release notes.
